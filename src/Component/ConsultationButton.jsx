...
const ConsultationButton = (props) => {
  ...
  return (
    <div className='text-white flex-center gap-x-4 md:gap-x-6 font-normal mt-10 md:mt-8 '>
        ...
        <div className={`w-[95px] h-[95px] lg:w-[105px] lg:h-[105px] design-border-outer-green flex-center rounded-full border-green ${props.buttonValue.green === "Consulting" ? 'w-[95px] h-[95px] lg:w-[110px] lg:h-[110px]' : ""}`} onClick = {() => {props.click()}}>
