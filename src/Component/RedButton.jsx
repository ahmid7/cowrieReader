...
const RedButton = (props) => {
  ...
  return (
    <div>
        <div className={`w-[72px] h-[72px] lg:w-[85px] lg:h-[85px] cursor-pointer flex-center rounded-full design-border-outer-red flex-center ${buttonclick ? 'animate-spins' : ''}`} onClick = {handleButton}>
